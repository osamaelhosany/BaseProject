...
namespace BaseMvvmToolKIt
{
    public interface IPageModelCoreMethods
    {
        ...
        Task PushPageModel<T>(object data, bool modal = false, bool animate = true) where T : BaseViewModel;

        Task PushPageModel<T, TPage>(object data, bool modal = false, bool animate = true) where T : BaseViewModel where TPage : Page;

        Task PopPageModel(bool modal = false, bool animate = true);

        Task PopPageModel(object data, bool modal = false, bool animate = true);

        Task PushPageModel<T>(bool animate = true) where T : BaseViewModel;

        Task PushPageModel<T, TPage>(bool animate = true) where T : BaseViewModel where TPage : Page;
        ...
        void RemoveFromNavigation<TPageModel>(bool removeAll = false) where TPageModel : BaseViewModel;
        ...
        Task<string> PushPageModelWithNewNavigation<T>(object data, bool animate = true) where T : BaseViewModel;
        ...
        Task PushNewNavigationServiceModal(TabbedNavigationContainer tabbedNavigationContainer, BaseViewModel basePageModel = null, bool animate = true);

        Task PushNewNavigationServiceModal(MasterDetailNavigationContainer masterDetailContainer, BaseViewModel basePageModel = null, bool animate = true);
